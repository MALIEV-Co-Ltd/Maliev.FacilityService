...
public sealed class WorkflowSecurityContractTests
{
    ...
    private static string FindRepositoryRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "Maliev.FacilityService.slnx")))
            {
        ...
        throw new DirectoryNotFoundException("Could not locate the FacilityService repository root.");
    }
}
